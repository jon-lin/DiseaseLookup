...
class WordCloud extends React.Component {
  constructor() {
    ...
    this.state = {numOfArticles: 0, loading: true};
  }

  componentDidMount() {
      //Much code used from example: https://bl.ocks.org/blockspring/847a40e23f68d6d7e8b5
      ...
      function drawWordCloud(text_string){
        ...
        var svg_location = "#wordCloudDiv";
        var w = $(`.wordCloudSlide`).width();
        var h = $(`.wordCloudSlide`).height() - $(`#wcTitleContainer`).height();
